	...
	({ inputData, handleUnexpand, isExpanded }, inputRef) => {
		return (
			<input
				...
				className={`text-xl font-serif dark:text-slate-100 block w-full pl-16 pr-3 py-2.5 sm:text-lg border border-gray-300 dark:border-gray-300 rounded-lg shadow-xl dark:shadow-lg dark:shadow-slate-800 bg-amber-50 dark:bg-slate-800  ${
